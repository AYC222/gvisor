...
func (e *endpoint) Forwarding() bool {
	return uint8(atomic.LoadUint32(&e.forwarding)) == 1
}

// setForwarding sets the forwarding status for the endpoint.
//
// Returns true iff the forwarding status was updated.
func (e *endpoint) setForwarding(v bool) bool {
	if v {
		return atomic.CompareAndSwapUint32(&e.forwarding, 0 /* old */, 1 /* new */)
	}
	return atomic.CompareAndSwapUint32(&e.forwarding, 1 /* old */, 0 /* new */)
}
